...
from django.contrib.auth.views import PasswordChangeView as DjangoPasswordChangeView  # Djangoの組み込みパスワード変更ビューのインポート
from django.contrib.auth.views import PasswordResetConfirmView as DjangoPasswordResetConfirmView  # Djangoの組み込みパスワードリセット確認ビューのインポート
from django.contrib.auth.forms import SetPasswordForm  # パスワード設定フォームのインポート
...
# ②このアプリ内のモデルとフォーム
from .forms import RegistForm, UserLoginForm, CustomPasswordChangeForm  # このアプリ内のフォームクラスのインポート
